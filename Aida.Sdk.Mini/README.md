...
------------ | ------------- | ------------- | -------------
*IntegrationApi* | [**AidaV1ScannerLayoutsImportValidateGet**](docs/IntegrationApi.md#aidav1scannerlayoutsimportvalidateget) | **GET** /aida/v1/scanner/layouts/import/_validate | 
*IntegrationApi* | [**ApiV1PcscGatewayReleaseContextPost**](docs/IntegrationApi.md#apiv1pcscgatewayreleasecontextpost) | **POST** /api/v1/pcsc-gateway/release-context | 
...
## Documentation for Models
 ...
 - [Model.PersonalizationTask](docs/PersonalizationTask.md)
 - [Model.PersonalizationTaskErrorCodes](docs/PersonalizationTaskErrorCodes.md)
 - [Model.PersonalizationTaskStatus](docs/PersonalizationTaskStatus.md)
 - [Model.PersonalizationTaskType](docs/PersonalizationTaskType.md)
 ...
 - [Model.ScannerModuleDescriptor](docs/ScannerModuleDescriptor.md)
