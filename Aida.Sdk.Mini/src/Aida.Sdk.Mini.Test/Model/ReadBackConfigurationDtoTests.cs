...
namespace Aida.Sdk.Mini.Test.Model
{
    ...
    public class ReadBackConfigurationDtoTests : IDisposable
    {
        ...
        /// <summary>
        /// Test deserialize a BarcodeReadBackConfigurationDto from type ReadBackConfigurationDto
        /// </summary>
        [Fact]
        public void BarcodeReadBackConfigurationDtoDeserializeFromReadBackConfigurationDtoTest()
        {
            // TODO uncomment below to test deserialize a BarcodeReadBackConfigurationDto from type ReadBackConfigurationDto
            //Assert.IsType<ReadBackConfigurationDto>(JsonConvert.DeserializeObject<ReadBackConfigurationDto>(new BarcodeReadBackConfigurationDto().ToJson()));
        }
        /// <summary>
