...
namespace Aida.Sdk.Mini.Test.Model
{
    ...
    public class WorkflowMessageTests : IDisposable
    {
        ...
        /// <summary>
        /// Test deserialize a BarcodeReadBackMessage from type WorkflowMessage
        /// </summary>
        [Fact]
        public void BarcodeReadBackMessageDeserializeFromWorkflowMessageTest()
        {
            // TODO uncomment below to test deserialize a BarcodeReadBackMessage from type WorkflowMessage
            //Assert.IsType<WorkflowMessage>(JsonConvert.DeserializeObject<WorkflowMessage>(new BarcodeReadBackMessage().ToJson()));
        }
        /// <summary>
        /// Test deserialize a BarcodeReadExecutedMessage from type WorkflowMessage
        /// </summary>
        [Fact]
        public void BarcodeReadExecutedMessageDeserializeFromWorkflowMessageTest()
        {
            // TODO uncomment below to test deserialize a BarcodeReadExecutedMessage from type WorkflowMessage
            //Assert.IsType<WorkflowMessage>(JsonConvert.DeserializeObject<WorkflowMessage>(new BarcodeReadExecutedMessage().ToJson()));
        }
        /// <summary>
