...
namespace Aida.Sdk.Mini.Api
{
    ...
    public partial class IntegrationApi : IDisposable, IIntegrationApi
    {
        ...
        /// <param name="filename"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Aida.Sdk.Mini.Client.ApiResponse<Object> AidaV1ScannerLayoutsImportValidateGetWithHttpInfo(string layoutName = default(string), string filename = default(string))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Aida.Sdk.Mini.Client.ApiResponse<Object>> AidaV1ScannerLayoutsImportValidateGetWithHttpInfoAsync(string layoutName = default(string), string filename = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
