...
namespace Aida.Sdk.Mini.Model
{
    ...
    public partial class MagneticStripeReadBackMessage : WorkflowMessage, IEquatable<MagneticStripeReadBackMessage>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as MagneticStripeReadBackMessage);
        }

        /// <summary>
        /// Returns true if MagneticStripeReadBackMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of MagneticStripeReadBackMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MagneticStripeReadBackMessage input)
        {
            if (input == null)
            {
                return false;
