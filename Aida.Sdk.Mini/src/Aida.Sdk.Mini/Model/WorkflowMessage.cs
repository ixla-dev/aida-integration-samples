...
namespace Aida.Sdk.Mini.Model
{
    ...
    public partial class WorkflowMessage : IEquatable<WorkflowMessage>, IValidatableObject
    {
        ...
        public WorkflowMessage(string discriminator = default(string), string jobId = default(string), string batchId = default(string), string correlationId = default(string), string messageId = default(string), string workflowInstanceId = default(string), MessageType? messageType = default(MessageType?), JobStatus? jobStatus = default(JobStatus?), JobErrorCodes? errorCode = default(JobErrorCodes?), Dictionary<string, Object> additionalMetadata = default(Dictionary<string, Object>), List<PersonalizationTask> personalizationTasks = default(List<PersonalizationTask>), bool documentProduced = default(bool))
        {
