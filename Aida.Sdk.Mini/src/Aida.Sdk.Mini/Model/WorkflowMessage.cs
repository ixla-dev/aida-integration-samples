...
namespace Aida.Sdk.Mini.Model
{
    ...
    public partial class WorkflowMessage : IEquatable<WorkflowMessage>, IValidatableObject
    {
        ...
        public WorkflowMessage(string discriminator = default(string), string jobId = default(string), string correlationId = default(string), string messageId = default(string), string workflowInstanceId = default(string), JobErrorCodes? errorCode = default(JobErrorCodes?), MessageType? messageType = default(MessageType?), JobStatus? jobStatus = default(JobStatus?), List<PersonalizationTask> personalizationTasks = default(List<PersonalizationTask>), bool documentProduced = default(bool))
        {
            ...
            this.PersonalizationTasks = personalizationTasks;
        ...
        /// <summary>
        /// Gets or Sets PersonalizationTasks
        /// </summary>
        [DataMember(Name = "personalizationTasks", EmitDefaultValue = true)]
        public List<PersonalizationTask> PersonalizationTasks { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PersonalizationTasks: ").Append(PersonalizationTasks).Append("\n");
        ...
        public bool Equals(WorkflowMessage input)
        {
            ...
            return 
                ...
                (
                    this.PersonalizationTasks == input.PersonalizationTasks ||
                    this.PersonalizationTasks != null &&
                    input.PersonalizationTasks != null &&
                    this.PersonalizationTasks.SequenceEqual(input.PersonalizationTasks)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PersonalizationTasks != null)
                {
                    hashCode = (hashCode * 59) + this.PersonalizationTasks.GetHashCode();
                }
