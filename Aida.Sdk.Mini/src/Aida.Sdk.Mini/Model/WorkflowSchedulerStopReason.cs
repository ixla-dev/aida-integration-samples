...
namespace Aida.Sdk.Mini.Model
{
    ...
    public enum WorkflowSchedulerStopReason
    {
        ...
        /// <summary>
        /// Enum SystemShutdown for value: SystemShutdown
        /// </summary>
        [EnumMember(Value = "SystemShutdown")]
        SystemShutdown = 9,

        /// <summary>
        /// Enum LaserSourceEnableFailed for value: LaserSourceEnableFailed
        /// </summary>
        [EnumMember(Value = "LaserSourceEnableFailed")]
        LaserSourceEnableFailed = 10,

        /// <summary>
        /// Enum SjfPreLoadFailed for value: SjfPreLoadFailed
        /// </summary>
        [EnumMember(Value = "SjfPreLoadFailed")]
        SjfPreLoadFailed = 11
