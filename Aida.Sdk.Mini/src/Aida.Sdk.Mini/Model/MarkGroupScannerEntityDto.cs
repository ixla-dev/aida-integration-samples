...
namespace Aida.Sdk.Mini.Model
{
    ...
    public partial class MarkGroupScannerEntityDto : IEquatable<MarkGroupScannerEntityDto>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as MarkGroupScannerEntityDto);
        }

        /// <summary>
        /// Returns true if MarkGroupScannerEntityDto instances are equal
        /// </summary>
        /// <param name="input">Instance of MarkGroupScannerEntityDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarkGroupScannerEntityDto input)
        {
            if (input == null)
            {
                return false;
