...
namespace Aida.Sdk.Mini.Model
{
    ...
    public partial class JobTemplateDto : IEquatable<JobTemplateDto>, IValidatableObject
    {
        ...
        /// <param name="cardOrientationTemplateMatchingSettings">cardOrientationTemplateMatchingSettings.</param>
        ...
        public JobTemplateDto(int? id = default(int?), string name = default(string), string description = default(string), DateTime? createdAt = default(DateTime?), DateTime? updatedAt = default(DateTime?), string expectedMarkDuration = default(string), DRectangleDto workingArea = default(DRectangleDto), SupportSide? feedSide = default(SupportSide?), TemplateMatchingConfigurationDto cardOrientationTemplateMatchingSettings = default(TemplateMatchingConfigurationDto), ReadBackConfigurationDto readBackConfiguration = default(ReadBackConfigurationDto), ChipEncodingConfigurationDto chipEncodingConfiguration = default(ChipEncodingConfigurationDto), MagneticStripeConfigurationDto magStripeConfiguration = default(MagneticStripeConfigurationDto), WebhooksTargetDto webhooksTarget = default(WebhooksTargetDto), FileDto file = default(FileDto), DataSourceConfigurationDto dataSourceConfiguration = default(DataSourceConfigurationDto), List<JobTemplateLayoutDto> layouts = default(List<JobTemplateLayoutDto>), List<JobTemplateInkjetLayoutDto> inkjetLayouts = default(List<JobTemplateInkjetLayoutDto>), List<ScannerMarkGroupDto> markGroups = default(List<ScannerMarkGroupDto>), List<JobTemplateOcrSettingsDto> ocrSettings = default(List<JobTemplateOcrSettingsDto>), List<JobTemplateBarcodeReadSettingsDto> barcodeReadSettings = default(List<JobTemplateBarcodeReadSettingsDto>), bool autoPosEnabled = default(bool))
        {
            this.Id = id;
            this.Name = name;
            ...
            this.CardOrientationTemplateMatchingSettings = cardOrientationTemplateMatchingSettings;
        ...
        /// <summary>
        /// Gets or Sets CardOrientationTemplateMatchingSettings
        /// </summary>
        [DataMember(Name = "cardOrientationTemplateMatchingSettings", EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "barcodeReadSettings", EmitDefaultValue = true)]
        public List<JobTemplateBarcodeReadSettingsDto> BarcodeReadSettings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CardOrientationTemplateMatchingSettings: ").Append(CardOrientationTemplateMatchingSettings).Append("\n");
        ...
        public bool Equals(JobTemplateDto input)
        {
            ...
            return 
                ...
                (
                    this.CardOrientationTemplateMatchingSettings == input.CardOrientationTemplateMatchingSettings ||
                    (this.CardOrientationTemplateMatchingSettings != null &&
                    this.CardOrientationTemplateMatchingSettings.Equals(input.CardOrientationTemplateMatchingSettings))
                ) && 
                (
                ...
                (
                    ...
                    input.BarcodeReadSettings != null &&
                    this.BarcodeReadSettings.SequenceEqual(input.BarcodeReadSettings)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CardOrientationTemplateMatchingSettings != null)
                {
                    hashCode = (hashCode * 59) + this.CardOrientationTemplateMatchingSettings.GetHashCode();
                }
