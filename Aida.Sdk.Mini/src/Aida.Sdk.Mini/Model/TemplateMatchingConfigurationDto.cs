...
namespace Aida.Sdk.Mini.Model
{
    ...
    public partial class TemplateMatchingConfigurationDto : IEquatable<TemplateMatchingConfigurationDto>, IValidatableObject
    {
        ...
        public TemplateMatchingConfigurationDto(int id = default(int), string name = default(string), string displayName = default(string), string description = default(string), double threshold = default(double), bool warpPerspective = default(bool), string scannerId = default(string), string acquisitionPresetName = default(string), DateTime? createdAt = default(DateTime?), DateTime? updatedAt = default(DateTime?), RectangleDto searchArea = default(RectangleDto), RectangleDto templateArea = default(RectangleDto), ApplicationImageDto searchPatternImage = default(ApplicationImageDto), string debugUrl = default(string), ScannerModuleDescriptor scannerModule = default(ScannerModuleDescriptor))
        {
            this.Id = id;
            this.Name = name;
        ...
        public ScannerModuleDescriptor ScannerModule { get; set; }
