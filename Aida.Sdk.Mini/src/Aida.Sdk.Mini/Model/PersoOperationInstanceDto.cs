...
namespace Aida.Sdk.Mini.Model
{
    ...
    public partial class PersoOperationInstanceDto : IEquatable<PersoOperationInstanceDto>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as PersoOperationInstanceDto);
        }

        /// <summary>
        /// Returns true if PersoOperationInstanceDto instances are equal
        /// </summary>
        /// <param name="input">Instance of PersoOperationInstanceDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersoOperationInstanceDto input)
        {
            if (input == null)
            {
                return false;
