...
namespace Aida.Sdk.Mini.Model
{
    ...
    public partial class SearchJobLayoutsResultDto : IEquatable<SearchJobLayoutsResultDto>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SearchJobLayoutsResultDto);
        }

        /// <summary>
        /// Returns true if SearchJobLayoutsResultDto instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchJobLayoutsResultDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchJobLayoutsResultDto input)
        {
            if (input == null)
            {
                return false;
