...
namespace Aida.Sdk.Mini.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ScannerModuleDescriptor")]
    public partial class ScannerModuleDescriptor : IEquatable<ScannerModuleDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScannerModuleDescriptor" /> class.
        /// </summary>
        ...
        public ScannerModuleDescriptor(string id = default(string), string baseAddress = default(string), string name = default(string), string displayName = default(string), string positionId = default(string), List<DeviceDefinition> devices = default(List<DeviceDefinition>))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScannerModuleDescriptor {\n");
        ...
        {
            return this.Equals(input as ScannerModuleDescriptor);
        }

        /// <summary>
        /// Returns true if ScannerModuleDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of ScannerModuleDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScannerModuleDescriptor input)
        {
            if (input == null)
            {
                return false;
