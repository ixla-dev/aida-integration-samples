...
namespace Aida.Sdk.Mini.Model
{
    ...
    public partial class WorkflowSchedulerStartupParamsDto : IEquatable<WorkflowSchedulerStartupParamsDto>, IValidatableObject
    {
        ...
        public bool Equals(WorkflowSchedulerStartupParamsDto input)
        {
            ...
            return 
                (
                    this.RejectedCardsThreshold == input.RejectedCardsThreshold ||
                    this.RejectedCardsThreshold.Equals(input.RejectedCardsThreshold)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = (hashCode * 59) + this.RejectedCardsThreshold.GetHashCode();
