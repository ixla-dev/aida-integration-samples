...
namespace Aida.Sdk.Mini.Model
{
    ...
    public partial class SearchJobTemplatesResultDto : IEquatable<SearchJobTemplatesResultDto>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SearchJobTemplatesResultDto);
        }

        /// <summary>
        /// Returns true if SearchJobTemplatesResultDto instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchJobTemplatesResultDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchJobTemplatesResultDto input)
        {
            if (input == null)
            {
                return false;
