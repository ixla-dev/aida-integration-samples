...
namespace Aida.Sdk.Mini.Model
{
    ...
    public partial class WorkflowSchedulerStateDto : IEquatable<WorkflowSchedulerStateDto>, IValidatableObject
    {
        ...
        public WorkflowSchedulerStateDto(WorkflowSchedulerStatus? status = default(WorkflowSchedulerStatus?), List<WorkflowSchedulerErrorCodes> errors = default(List<WorkflowSchedulerErrorCodes>), int queueSize = default(int), List<int> queuedOrderIds = default(List<int>), string errorDetails = default(string), int lastLoadedItemId = default(int), int upTimeSeconds = default(int), JobTemplateDto currentJobTemplate = default(JobTemplateDto), string sessionId = default(string))
        {
            this.Status = status;
            this.Errors = errors;
