...
namespace Aida.Sdk.Mini.Model
{
    ...
    public partial class WorkflowSchedulerStateDto : IEquatable<WorkflowSchedulerStateDto>, IValidatableObject
    {
        ...
        /// <param name="startupParameters">startupParameters.</param>
        public WorkflowSchedulerStateDto(WorkflowSchedulerStatus? status = default(WorkflowSchedulerStatus?), WorkflowSchedulerStopReason? stopReason = default(WorkflowSchedulerStopReason?), List<WorkflowSchedulerErrorCodes> errors = default(List<WorkflowSchedulerErrorCodes>), string stopSourceJobId = default(string), int queueSize = default(int), List<int> queuedOrderIds = default(List<int>), string errorDetails = default(string), int lastLoadedItemId = default(int), int upTimeSeconds = default(int), string workflowTypeName = default(string), string sessionId = default(string), WorkflowSchedulerStartupParamsDto startupParameters = default(WorkflowSchedulerStartupParamsDto))
        {
            this.Status = status;
        ...
        /// <summary>
        /// Gets or Sets StartupParameters
        /// </summary>
        [DataMember(Name = "startupParameters", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  StartupParameters: ").Append(StartupParameters).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(WorkflowSchedulerStateDto input)
        {
            ...
            return 
                ...
                (
                    this.StopSourceJobId == input.StopSourceJobId ||
                    (this.StopSourceJobId != null &&
                    this.StopSourceJobId.Equals(input.StopSourceJobId))
                ) && 
                (
                ...
                (
                    this.CurrentJobTemplateName == input.CurrentJobTemplateName ||
                    (this.CurrentJobTemplateName != null &&
                    this.CurrentJobTemplateName.Equals(input.CurrentJobTemplateName))
                ) && 
                (
                    this.CurrentJobTemplateId == input.CurrentJobTemplateId ||
                    (this.CurrentJobTemplateId != null &&
                    this.CurrentJobTemplateId.Equals(input.CurrentJobTemplateId))
                ) && 
                (
                ...
                (
                    this.StartupParameters == input.StartupParameters ||
                    (this.StartupParameters != null &&
                    this.StartupParameters.Equals(input.StartupParameters))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StopSourceJobId != null)
                {
                    hashCode = (hashCode * 59) + this.StopSourceJobId.GetHashCode();
                }
                ...
                if (this.CurrentJobTemplateName != null)
                {
                    hashCode = (hashCode * 59) + this.CurrentJobTemplateName.GetHashCode();
                }
                if (this.CurrentJobTemplateId != null)
                {
                    hashCode = (hashCode * 59) + this.CurrentJobTemplateId.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.StartupParameters.GetHashCode();
                }
                return hashCode;
            }
        }
