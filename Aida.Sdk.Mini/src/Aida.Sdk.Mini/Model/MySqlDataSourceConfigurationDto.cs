...
namespace Aida.Sdk.Mini.Model
{
    ...
    public partial class MySqlDataSourceConfigurationDto : DataSourceConfigurationDto, IEquatable<MySqlDataSourceConfigurationDto>, IValidatableObject
    {
        ...
        public MySqlDataSourceConfigurationDto(string tableName = default(string), string queryTemplate = default(string), string connectionString = default(string), string provider = default(string), string discriminator = "MySqlDataSourceConfigurationDto", int? id = default(int?), int? jobTemplateId = default(int?), string name = default(string), DataSourceType? dataSourceType = default(DataSourceType?), bool canBeDeleted = default(bool)) : base(discriminator, id, jobTemplateId, name, dataSourceType, canBeDeleted)
        {
