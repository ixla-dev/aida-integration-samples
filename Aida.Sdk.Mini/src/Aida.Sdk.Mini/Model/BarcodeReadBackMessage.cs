...
{
    /// <summary>
    /// BarcodeReadBackMessage
    /// </summary>
    [DataContract(Name = "BarcodeReadBackMessage")]
    ...
    public partial class BarcodeReadBackMessage : WorkflowMessage, IEquatable<BarcodeReadBackMessage>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BarcodeReadBackMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BarcodeReadBackMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BarcodeReadBackMessage" /> class.
        /// </summary>
        /// <param name="barcodeFormat">barcodeFormat.</param>
        /// <param name="decodedBytes">decodedBytes.</param>
        /// <param name="discriminator">discriminator (required) (default to &quot;BarcodeReadBackMessage&quot;).</param>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BarcodeReadBackMessage {\n");
        ...
        {
            return this.Equals(input as BarcodeReadBackMessage);
        }

        /// <summary>
        /// Returns true if BarcodeReadBackMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of BarcodeReadBackMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BarcodeReadBackMessage input)
        {
            if (input == null)
            {
                return false;
