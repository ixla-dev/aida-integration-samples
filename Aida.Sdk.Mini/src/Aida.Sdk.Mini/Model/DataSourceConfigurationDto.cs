...
namespace Aida.Sdk.Mini.Model
{
    ...
    public partial class DataSourceConfigurationDto : IEquatable<DataSourceConfigurationDto>, IValidatableObject
    {
        ...
        public DataSourceConfigurationDto(string discriminator = default(string), int? id = default(int?), int? jobTemplateId = default(int?), string name = default(string), DataSourceType? dataSourceType = default(DataSourceType?), bool canBeDeleted = default(bool))
        {
        ...
        /// </summary>
        [DataMember(Name = "jobTemplateId", EmitDefaultValue = true)]
