...
namespace Aida.Sdk.Mini.Model
{
    ...
    public partial class DataSourceConfigurationDto : IEquatable<DataSourceConfigurationDto>, IValidatableObject
    {
        ...
        public DataSourceConfigurationDto(string discriminator = default(string), int? id = default(int?), string name = default(string), DataSourceType? dataSourceType = default(DataSourceType?))
        {
