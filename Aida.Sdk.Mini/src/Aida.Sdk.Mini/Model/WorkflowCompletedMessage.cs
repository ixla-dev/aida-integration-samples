...
namespace Aida.Sdk.Mini.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WorkflowCompletedMessage")]
    ...
    public partial class WorkflowCompletedMessage : WorkflowMessage, IEquatable<WorkflowCompletedMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkflowCompletedMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WorkflowCompletedMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkflowCompletedMessage" /> class.
        /// </summary>
        /// <param name="discriminator">discriminator (required) (default to &quot;WorkflowCompletedMessage&quot;).</param>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkflowCompletedMessage {\n");
        ...
        {
            return this.Equals(input as WorkflowCompletedMessage);
        }

        /// <summary>
        /// Returns true if WorkflowCompletedMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkflowCompletedMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkflowCompletedMessage input)
        {
            if (input == null)
            {
                return false;
