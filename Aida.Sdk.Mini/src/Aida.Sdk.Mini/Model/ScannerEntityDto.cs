    ...
    public partial class ScannerEntityDto : IEquatable<ScannerEntityDto>, IValidatableObject
    {
        ...
        public bool Equals(ScannerEntityDto input)
        {
            ...
            return 
                ...
                (
                    this.TextLengthLimit == input.TextLengthLimit ||
                    (this.TextLengthLimit != null &&
                    this.TextLengthLimit.Equals(input.TextLengthLimit))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TextLengthLimit != null)
                {
                    hashCode = (hashCode * 59) + this.TextLengthLimit.GetHashCode();
                }
