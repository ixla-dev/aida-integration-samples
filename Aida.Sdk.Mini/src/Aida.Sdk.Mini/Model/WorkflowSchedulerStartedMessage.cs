...
namespace Aida.Sdk.Mini.Model
{
    ...
    public partial class WorkflowSchedulerStartedMessage : WorkflowMessage, IEquatable<WorkflowSchedulerStartedMessage>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as WorkflowSchedulerStartedMessage);
        }

        /// <summary>
        /// Returns true if WorkflowSchedulerStartedMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkflowSchedulerStartedMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkflowSchedulerStartedMessage input)
        {
            if (input == null)
            {
                return false;
