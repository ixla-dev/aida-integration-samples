...
namespace Aida.Sdk.Mini.Model
{
    ...
    public partial class InkjetEntityDto : IEquatable<InkjetEntityDto>, IValidatableObject
    {
        ...
        public InkjetEntityDto(int id = default(int), string name = default(string), string displayName = default(string), float x = default(float), float y = default(float), float width = default(float), float height = default(float))
        {
            this.Id = id;
            this.Name = name;
