...
namespace Aida.Sdk.Mini.Model
{
    ...
    public partial class WorkflowSchedulerStoppingMessage : WorkflowMessage, IEquatable<WorkflowSchedulerStoppingMessage>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as WorkflowSchedulerStoppingMessage);
        }

        /// <summary>
        /// Returns true if WorkflowSchedulerStoppingMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkflowSchedulerStoppingMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkflowSchedulerStoppingMessage input)
        {
            if (input == null)
            {
                return false;
