...
namespace Aida.Sdk.Mini.Model
{
    ...
    public partial class WebhookReceiverHealthCheckMessage : WorkflowMessage, IEquatable<WebhookReceiverHealthCheckMessage>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as WebhookReceiverHealthCheckMessage);
        }

        /// <summary>
        /// Returns true if WebhookReceiverHealthCheckMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookReceiverHealthCheckMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookReceiverHealthCheckMessage input)
        {
            if (input == null)
            {
                return false;
