...
namespace Aida.Sdk.Mini.Model
{
    ...
    public enum JobErrorCodes
    {
        ...
        /// <summary>
        /// Enum FailedToLoadJobTemplate for value: FailedToLoadJobTemplate
        /// </summary>
        [EnumMember(Value = "FailedToLoadJobTemplate")]
        FailedToLoadJobTemplate = 22,

        /// <summary>
        /// Enum InvalidTransportStatus for value: InvalidTransportStatus
        /// </summary>
        [EnumMember(Value = "InvalidTransportStatus")]
        InvalidTransportStatus = 23,

        /// <summary>
        /// Enum ReadBackValidationFailed for value: ReadBackValidationFailed
        /// </summary>
        [EnumMember(Value = "ReadBackValidationFailed")]
        ReadBackValidationFailed = 24,

        /// <summary>
        /// Enum InvalidCardOrientation for value: InvalidCardOrientation
        /// </summary>
        [EnumMember(Value = "InvalidCardOrientation")]
        InvalidCardOrientation = 25,

        /// <summary>
        /// Enum InkjetPrintFailed for value: InkjetPrintFailed
        /// </summary>
        [EnumMember(Value = "InkjetPrintFailed")]
        InkjetPrintFailed = 26,

        /// <summary>
        /// Enum BarcodeDecodingFailed for value: BarcodeDecodingFailed
        /// </summary>
        [EnumMember(Value = "BarcodeDecodingFailed")]
        BarcodeDecodingFailed = 27,

        /// <summary>
        /// Enum BarcodeImageAcquisitionFailed for value: BarcodeImageAcquisitionFailed
        /// </summary>
        [EnumMember(Value = "BarcodeImageAcquisitionFailed")]
        BarcodeImageAcquisitionFailed = 28,

        /// <summary>
        /// Enum BarcodeExternalValidationKo for value: BarcodeExternalValidationKo
        /// </summary>
        [EnumMember(Value = "BarcodeExternalValidationKo")]
        BarcodeExternalValidationKo = 29
