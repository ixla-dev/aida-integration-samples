...
namespace Aida.Sdk.Mini.Model
{
    ...
    /// JobInstanceDto
    /// </summary>
    [DataContract(Name = "JobInstanceDto")]
    public partial class JobInstanceDto : IEquatable<JobInstanceDto>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JobInstanceDto" /> class.
        /// </summary>
        ...
        public JobInstanceDto(int id = default(int), string jobId = default(string), string workflowInstanceId = default(string), string correlationId = default(string), string sessionId = default(string), string batchId = default(string), JobStatus? jobStatus = default(JobStatus?), JobErrorCodes? errorCodes = default(JobErrorCodes?), DateTime? createdAt = default(DateTime?), DateTime? startedAt = default(DateTime?), DateTime? updatedAt = default(DateTime?), DateTime? finishedAt = default(DateTime?), List<PersoOperationInstanceDto> persoOperations = default(List<PersoOperationInstanceDto>), string executingOperationId = default(string), string currentPositionId = default(string), bool documentProduced = default(bool))
        {
            this.Id = id;
            this.JobId = jobId;
        ...
        public List<PersoOperationInstanceDto> PersoOperations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JobInstanceDto {\n");
        ...
        {
            return this.Equals(input as JobInstanceDto);
        }

        /// <summary>
        /// Returns true if JobInstanceDto instances are equal
        /// </summary>
        /// <param name="input">Instance of JobInstanceDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobInstanceDto input)
        {
            if (input == null)
            {
                return false;
