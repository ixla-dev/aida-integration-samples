...
namespace Aida.Sdk.Mini.Model
{
    ...
    public partial class DeviceDefinition : IEquatable<DeviceDefinition>, IValidatableObject
    {
        ...
        public DeviceDefinition(string id = default(string), string name = default(string), string displayName = default(string), string positionId = default(string), string description = default(string), string serialNumber = default(string), string moduleId = default(string), DeviceType? deviceType = default(DeviceType?))
        {
            this.Id = id;
            this.Name = name;
