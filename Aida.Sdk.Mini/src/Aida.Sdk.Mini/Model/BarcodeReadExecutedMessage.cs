...
{
    /// <summary>
    /// BarcodeReadExecutedMessage
    /// </summary>
    [DataContract(Name = "BarcodeReadExecutedMessage")]
    ...
    public partial class BarcodeReadExecutedMessage : WorkflowMessage, IEquatable<BarcodeReadExecutedMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BarcodeReadExecutedMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BarcodeReadExecutedMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BarcodeReadExecutedMessage" /> class.
        /// </summary>
        /// <param name="results">results.</param>
        /// <param name="discriminator">discriminator (required) (default to &quot;BarcodeReadExecutedMessage&quot;).</param>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BarcodeReadExecutedMessage {\n");
        ...
        {
            return this.Equals(input as BarcodeReadExecutedMessage);
        }

        /// <summary>
        /// Returns true if BarcodeReadExecutedMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of BarcodeReadExecutedMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BarcodeReadExecutedMessage input)
        {
            if (input == null)
            {
                return false;
