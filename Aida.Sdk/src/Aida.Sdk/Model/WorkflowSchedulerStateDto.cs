...
namespace Aida.Sdk.Model
{
    ...
    public partial class WorkflowSchedulerStateDto : IEquatable<WorkflowSchedulerStateDto>, IValidatableObject
    {
        ...
        public WorkflowSchedulerStateDto(WorkflowSchedulerStatus? status = default(WorkflowSchedulerStatus?), WorkflowSchedulerStopReason? stopReason = default(WorkflowSchedulerStopReason?), List<WorkflowSchedulerErrorCodes> errors = default(List<WorkflowSchedulerErrorCodes>), string stopSourceJobId = default(string), int queueSize = default(int), List<int> queuedOrderIds = default(List<int>), string errorDetails = default(string), int lastLoadedItemId = default(int), int upTimeSeconds = default(int), JobTemplateDto currentJobTemplate = default(JobTemplateDto), string workflowTypeName = default(string), string sessionId = default(string))
        {
            this.Status = status;
