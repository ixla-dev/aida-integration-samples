...
namespace Aida.Sdk.Model
{
    ...
    public partial class WorkflowInstanceDtoPagedList : IEquatable<WorkflowInstanceDtoPagedList>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as WorkflowInstanceDtoPagedList);
        }

        /// <summary>
        /// Returns true if WorkflowInstanceDtoPagedList instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkflowInstanceDtoPagedList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkflowInstanceDtoPagedList input)
        {
            if (input == null)
            {
                return false;
