...
namespace Aida.Sdk.Model
{
    ...
    public partial class SamLightAxisState : IEquatable<SamLightAxisState>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SamLightAxisState);
        }

        /// <summary>
        /// Returns true if SamLightAxisState instances are equal
        /// </summary>
        /// <param name="input">Instance of SamLightAxisState to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SamLightAxisState input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.XInverted == input.XInverted ||
                    this.XInverted.Equals(input.XInverted)
                ) && 
                (
                    this.YInverted == input.YInverted ||
                    this.YInverted.Equals(input.YInverted)
                ) && 
                (
                    this.ZInverted == input.ZInverted ||
                    this.ZInverted.Equals(input.ZInverted)
                ) && 
                (
                    this.XyFlipped == input.XyFlipped ||
                    this.XyFlipped.Equals(input.XyFlipped)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = (hashCode * 59) + this.XInverted.GetHashCode();
                hashCode = (hashCode * 59) + this.YInverted.GetHashCode();
                hashCode = (hashCode * 59) + this.ZInverted.GetHashCode();
                hashCode = (hashCode * 59) + this.XyFlipped.GetHashCode();
                return hashCode;
            }
        }
