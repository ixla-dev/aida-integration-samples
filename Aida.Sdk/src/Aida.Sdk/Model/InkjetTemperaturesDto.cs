...
namespace Aida.Sdk.Model
{
    ...
    public partial class InkjetTemperaturesDto : IEquatable<InkjetTemperaturesDto>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as InkjetTemperaturesDto);
        }

        /// <summary>
        /// Returns true if InkjetTemperaturesDto instances are equal
        /// </summary>
        /// <param name="input">Instance of InkjetTemperaturesDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InkjetTemperaturesDto input)
        {
            if (input == null)
            {
                return false;
