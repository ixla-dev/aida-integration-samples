...
namespace Aida.Sdk.Model
{
    ...
    public partial class SimulateActivityMessage : IEquatable<SimulateActivityMessage>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as SimulateActivityMessage);
        }

        /// <summary>
        /// Returns true if SimulateActivityMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of SimulateActivityMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimulateActivityMessage input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.DurationMilliseconds.Equals(input.DurationMilliseconds)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.DurationMilliseconds.GetHashCode();
                return hashCode;
            }
        }
