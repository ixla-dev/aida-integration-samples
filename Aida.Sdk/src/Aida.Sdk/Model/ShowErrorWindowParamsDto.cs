...
namespace Aida.Sdk.Model
{
    ...
    public partial class ShowErrorWindowParamsDto : IEquatable<ShowErrorWindowParamsDto>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ShowErrorWindowParamsDto);
        }

        /// <summary>
        /// Returns true if ShowErrorWindowParamsDto instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowErrorWindowParamsDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowErrorWindowParamsDto input)
        {
            if (input == null)
            {
                return false;
