...
namespace Aida.Sdk.Model
{
    ...
    public partial class TemplateMatchOccurence : IEquatable<TemplateMatchOccurence>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TemplateMatchOccurence);
        }

        /// <summary>
        /// Returns true if TemplateMatchOccurence instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplateMatchOccurence to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateMatchOccurence input)
        {
            if (input == null)
            {
                return false;
