...
namespace Aida.Sdk.Model
{
    ...
    public partial class PrintSettingsDto : IEquatable<PrintSettingsDto>, IValidatableObject
    {
        ...
        public bool Equals(PrintSettingsDto input)
        {
            ...
            return 
                (
                    ...
                    (this.JobTemplateInkjetLayoutId != null &&
                ...
                (
                    this.NumberOfPasses == input.NumberOfPasses ||
                    this.NumberOfPasses.Equals(input.NumberOfPasses)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.JobTemplateInkjetLayoutId != null)
                {
                ...
                hashCode = (hashCode * 59) + this.NumberOfPasses.GetHashCode();
