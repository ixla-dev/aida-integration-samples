...
namespace Aida.Sdk.Model
{
    ...
    public partial class WebHooksOptions : IEquatable<WebHooksOptions>, IValidatableObject
    {
        ...
        public WebHooksOptions(TimeSpan ackTimeout = default(TimeSpan), TimeSpan executionTimeout = default(TimeSpan), int? maxConnectionRetries = default(int?), bool useSystemWideWebhooks = default(bool), string systemWideWebhookTarget = default(string), string targetUrl = default(string))
        {
