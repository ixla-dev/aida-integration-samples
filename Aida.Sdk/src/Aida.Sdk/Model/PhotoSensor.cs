...
namespace Aida.Sdk.Model
{
    ...
    public partial class PhotoSensor : IEquatable<PhotoSensor>, IValidatableObject
    {
        /// <summary>
        ...
        public PhotoSensor(string name = default(string), bool isClosed = default(bool))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as PhotoSensor);
        }

        /// <summary>
        /// Returns true if PhotoSensor instances are equal
        /// </summary>
        /// <param name="input">Instance of PhotoSensor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PhotoSensor input)
        {
            if (input == null)
            {
                return false;
