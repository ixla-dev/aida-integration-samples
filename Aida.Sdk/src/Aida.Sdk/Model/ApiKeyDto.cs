...
namespace Aida.Sdk.Model
{
    ...
    public partial class ApiKeyDto : IEquatable<ApiKeyDto>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ApiKeyDto);
        }

        /// <summary>
        /// Returns true if ApiKeyDto instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiKeyDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiKeyDto input)
        {
            if (input == null)
            {
                return false;
