...
namespace Aida.Sdk.Model
{
    ...
    public partial class AlignEntitiesDto : IEquatable<AlignEntitiesDto>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as AlignEntitiesDto);
        }

        /// <summary>
        /// Returns true if AlignEntitiesDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AlignEntitiesDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlignEntitiesDto input)
        {
            if (input == null)
            {
                return false;
