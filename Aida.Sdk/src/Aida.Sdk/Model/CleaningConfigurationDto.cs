...
namespace Aida.Sdk.Model
{
    ...
    public partial class CleaningConfigurationDto : IEquatable<CleaningConfigurationDto>, IValidatableObject
    {
        ...
        public CleaningConfigurationDto(int normalPurgeDuration = default(int), int strongPurgeDuration = default(int), int wiperPassCount = default(int), int pumpSpeed = default(int), int mainSpittingCount = default(int), int mainSpittingFreq = default(int), int mainSpittingCycles = default(int), int finalSpittingCount = default(int), int finalSpittingFreq = default(int), int finalSpittingCycles = default(int), int inkPrimingTime = default(int), int vacuumPressureSetPoint = default(int), int spittingOffset = default(int), bool autoPark = default(bool), bool autoClean = default(bool), bool cleanAfterAutoPark = default(bool), int cleanFrequency = default(int), int secondsOfSleepBeforeAutoPark = default(int))
        {
            ...
            this.CleanAfterAutoPark = cleanAfterAutoPark;
        ...
        /// <summary>
        /// Gets or Sets CleanAfterAutoPark
        /// </summary>
        [DataMember(Name = "cleanAfterAutoPark", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CleanAfterAutoPark: ").Append(CleanAfterAutoPark).Append("\n");
        ...
        public bool Equals(CleaningConfigurationDto input)
        {
            ...
            return 
                ...
                (
                    this.CleanAfterAutoPark == input.CleanAfterAutoPark ||
                    this.CleanAfterAutoPark.Equals(input.CleanAfterAutoPark)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CleanAfterAutoPark.GetHashCode();
