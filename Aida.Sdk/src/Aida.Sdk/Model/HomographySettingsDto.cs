    ...
    public partial class HomographySettingsDto : IEquatable<HomographySettingsDto>, IValidatableObject
    {
        ...
        public bool Equals(HomographySettingsDto input)
        {
            ...
            return 
                ...
                (
                    this.UnwarpPerspectiveOutputSizeX == input.UnwarpPerspectiveOutputSizeX ||
                    this.UnwarpPerspectiveOutputSizeX.Equals(input.UnwarpPerspectiveOutputSizeX)
                ) && 
                (
                    this.UnwarpPerspectiveOutputSizeY == input.UnwarpPerspectiveOutputSizeY ||
                    this.UnwarpPerspectiveOutputSizeY.Equals(input.UnwarpPerspectiveOutputSizeY)
                ) && 
                (
                ...
                (
                    this.InverseHomography == input.InverseHomography ||
                    this.InverseHomography != null &&
                    input.InverseHomography != null &&
                    this.InverseHomography.SequenceEqual(input.InverseHomography)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.UnwarpPerspectiveOutputSizeX.GetHashCode();
                hashCode = (hashCode * 59) + this.UnwarpPerspectiveOutputSizeY.GetHashCode();
                ...
                if (this.InverseHomography != null)
                {
                    hashCode = (hashCode * 59) + this.InverseHomography.GetHashCode();
                }
                return hashCode;
            }
        }
