...
namespace Aida.Sdk.Model
{
    ...
    public partial class DisplayActionResult : IEquatable<DisplayActionResult>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as DisplayActionResult);
        }

        /// <summary>
        /// Returns true if DisplayActionResult instances are equal
        /// </summary>
        /// <param name="input">Instance of DisplayActionResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DisplayActionResult input)
        {
            if (input == null)
            {
                return false;
