    ...
    public partial class MachineStatusDto : IEquatable<MachineStatusDto>, IValidatableObject
    {
        ...
        public bool Equals(MachineStatusDto input)
        {
            ...
            return 
                ...
                (
                    this.AllFeedersEmpty == input.AllFeedersEmpty ||
                    this.AllFeedersEmpty.Equals(input.AllFeedersEmpty)
                ) && 
                (
                    this.SchedulerStatus == input.SchedulerStatus ||
                    this.SchedulerStatus.Equals(input.SchedulerStatus)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AllFeedersEmpty.GetHashCode();
                hashCode = (hashCode * 59) + this.SchedulerStatus.GetHashCode();
                return hashCode;
            }
        }
