...
namespace Aida.Sdk.Api
{
    ...
    public interface IApplicationApiSync : IApiAccessor
    {
        ...
        /// <param name="sectionPath"> (optional, default to &quot;&quot;)</param>
        /// <returns>Dictionary&lt;string, string&gt;</returns>
        Dictionary<string, string> GetAppConfiguration(string sectionPath = default(string));
        ...
        ApiResponse<Dictionary<string, string>> GetAppConfigurationWithHttpInfo(string sectionPath = default(string));
        /// <summary>
    ...
    public interface IApplicationApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Dictionary<string, string>> GetAppConfigurationAsync(string sectionPath = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Dictionary<string, string>>> GetAppConfigurationWithHttpInfoAsync(string sectionPath = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Returns the configuration object currently used by the system
        /// </summary>
        /// <remarks>
    ...
    public partial class ApplicationApi : IDisposable, IApplicationApi
    {
        ...
        /// <param name="sectionPath"> (optional, default to &quot;&quot;)</param>
        /// <returns>Dictionary&lt;string, string&gt;</returns>
        public Dictionary<string, string> GetAppConfiguration(string sectionPath = default(string))
        {
            Aida.Sdk.Client.ApiResponse<Dictionary<string, string>> localVarResponse = GetAppConfigurationWithHttpInfo(sectionPath);
        ...
        /// <param name="sectionPath"> (optional, default to &quot;&quot;)</param>
        /// <returns>ApiResponse of Dictionary&lt;string, string&gt;</returns>
        public Aida.Sdk.Client.ApiResponse<Dictionary<string, string>> GetAppConfigurationWithHttpInfo(string sectionPath = default(string))
        {
            ...
            if (sectionPath != null)
            {
                localVarRequestOptions.QueryParameters.Add(Aida.Sdk.Client.ClientUtils.ParameterToMultiMap("", "sectionPath", sectionPath));
            }
            ...
            var localVarResponse = this.Client.Get<Dictionary<string, string>>("/aida/v1/application/configuration", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetAppConfiguration", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Dictionary&lt;string, string&gt;</returns>
        public async System.Threading.Tasks.Task<Dictionary<string, string>> GetAppConfigurationAsync(string sectionPath = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Aida.Sdk.Client.ApiResponse<Dictionary<string, string>> localVarResponse = await GetAppConfigurationWithHttpInfoAsync(sectionPath, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, string&gt;)</returns>
        public async System.Threading.Tasks.Task<Aida.Sdk.Client.ApiResponse<Dictionary<string, string>>> GetAppConfigurationWithHttpInfoAsync(string sectionPath = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Dictionary<string, string>>("/aida/v1/application/configuration", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
