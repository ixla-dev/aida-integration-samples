...
namespace Aida.Sdk.Api
{
    ...
    public interface IAutoPosApiSync : IApiAccessor
    {
        ...
        /// <param name="scannerId"> (optional, default to &quot;&quot;)</param>
        /// <returns>TemplateMatchingResult</returns>
        TemplateMatchingResult ExecuteTemplateMatching(int templateMatchingConfigurationId, float? threshold = default(float?), string scannerId = default(string));
        ...
        /// <param name="threshold"> (optional, default to 0.9F)</param>
        /// <param name="scannerId"> (optional, default to &quot;&quot;)</param>
        /// <returns>ApiResponse of TemplateMatchingResult</returns>
        ApiResponse<TemplateMatchingResult> ExecuteTemplateMatchingWithHttpInfo(int templateMatchingConfigurationId, float? threshold = default(float?), string scannerId = default(string));
        /// <summary>
        /// 
        /// </summary>
        /// <exception cref="Aida.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    public interface IAutoPosApiAsync : IApiAccessor
    {
        ...
        /// <param name="scannerId"> (optional, default to &quot;&quot;)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TemplateMatchingResult</returns>
        System.Threading.Tasks.Task<TemplateMatchingResult> ExecuteTemplateMatchingAsync(int templateMatchingConfigurationId, float? threshold = default(float?), string scannerId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="scannerId"> (optional, default to &quot;&quot;)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TemplateMatchingResult)</returns>
        System.Threading.Tasks.Task<ApiResponse<TemplateMatchingResult>> ExecuteTemplateMatchingWithHttpInfoAsync(int templateMatchingConfigurationId, float? threshold = default(float?), string scannerId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class AutoPosApi : IDisposable, IAutoPosApi
    {
        ...
        /// <param name="scannerId"> (optional, default to &quot;&quot;)</param>
        /// <returns>TemplateMatchingResult</returns>
        public TemplateMatchingResult ExecuteTemplateMatching(int templateMatchingConfigurationId, float? threshold = default(float?), string scannerId = default(string))
        {
            Aida.Sdk.Client.ApiResponse<TemplateMatchingResult> localVarResponse = ExecuteTemplateMatchingWithHttpInfo(templateMatchingConfigurationId, threshold, scannerId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="scannerId"> (optional, default to &quot;&quot;)</param>
        /// <returns>ApiResponse of TemplateMatchingResult</returns>
        public Aida.Sdk.Client.ApiResponse<TemplateMatchingResult> ExecuteTemplateMatchingWithHttpInfo(int templateMatchingConfigurationId, float? threshold = default(float?), string scannerId = default(string))
        {
            Aida.Sdk.Client.RequestOptions localVarRequestOptions = new Aida.Sdk.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<TemplateMatchingResult>("/aida/v1/autopos/template-matching-configuration/{templateMatchingConfigurationId}/execute", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TemplateMatchingResult</returns>
        public async System.Threading.Tasks.Task<TemplateMatchingResult> ExecuteTemplateMatchingAsync(int templateMatchingConfigurationId, float? threshold = default(float?), string scannerId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Aida.Sdk.Client.ApiResponse<TemplateMatchingResult> localVarResponse = await ExecuteTemplateMatchingWithHttpInfoAsync(templateMatchingConfigurationId, threshold, scannerId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TemplateMatchingResult)</returns>
        public async System.Threading.Tasks.Task<Aida.Sdk.Client.ApiResponse<TemplateMatchingResult>> ExecuteTemplateMatchingWithHttpInfoAsync(int templateMatchingConfigurationId, float? threshold = default(float?), string scannerId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<TemplateMatchingResult>("/aida/v1/autopos/template-matching-configuration/{templateMatchingConfigurationId}/execute", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
