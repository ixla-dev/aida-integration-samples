...
namespace Aida.Sdk.Api
{
    ...
    public interface IConfigurationApiSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void UploadConfigFilePost(string scannerId = default(string), string apiVersion = default(string), List<FileParameter> fileParameter = default(List<FileParameter>));
        ...
        ApiResponse<Object> UploadConfigFilePostWithHttpInfo(string scannerId = default(string), string apiVersion = default(string), List<FileParameter> fileParameter = default(List<FileParameter>));
    ...
    public interface IConfigurationApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task UploadConfigFilePostAsync(string scannerId = default(string), string apiVersion = default(string), List<FileParameter> fileParameter = default(List<FileParameter>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> UploadConfigFilePostWithHttpInfoAsync(string scannerId = default(string), string apiVersion = default(string), List<FileParameter> fileParameter = default(List<FileParameter>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ConfigurationApi : IDisposable, IConfigurationApi
    {
        ...
        /// <param name="fileParameter"> (optional)</param>
        /// <returns></returns>
        public void UploadConfigFilePost(string scannerId = default(string), string apiVersion = default(string), List<FileParameter> fileParameter = default(List<FileParameter>))
        {
            UploadConfigFilePostWithHttpInfo(scannerId, apiVersion, fileParameter);
        }
        ...
        /// <param name="fileParameter"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Aida.Sdk.Client.ApiResponse<Object> UploadConfigFilePostWithHttpInfo(string scannerId = default(string), string apiVersion = default(string), List<FileParameter> fileParameter = default(List<FileParameter>))
        {
            Aida.Sdk.Client.RequestOptions localVarRequestOptions = new Aida.Sdk.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/upload_config_file", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("UploadConfigFilePost", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task UploadConfigFilePostAsync(string scannerId = default(string), string apiVersion = default(string), List<FileParameter> fileParameter = default(List<FileParameter>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await UploadConfigFilePostWithHttpInfoAsync(scannerId, apiVersion, fileParameter, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Aida.Sdk.Client.ApiResponse<Object>> UploadConfigFilePostWithHttpInfoAsync(string scannerId = default(string), string apiVersion = default(string), List<FileParameter> fileParameter = default(List<FileParameter>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/upload_config_file", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
