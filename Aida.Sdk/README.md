...
- API version: 1.0.722-rc.3+496a5e11f6297a76e2b83a2b26e743e21a1c18c1
- SDK version: 1.0.722-rc.3+496a5e11f6297a76e2b83a2b26e743e21a1c18c1
...
*ApplicationApi* | [**GetAppConfiguration**](docs/ApplicationApi.md#getappconfiguration) | **GET** /aida/v1/application/configuration | 
...
*AutoPosApi* | [**AidaV1AutoposInkjetCopyFromPost**](docs/AutoPosApi.md#aidav1autoposinkjetcopyfrompost) | **POST** /aida/v1/autopos/inkjet/copy-from | 
...
*BoxJuvApi* | [**GetShuttleAlignmentState**](docs/BoxJuvApi.md#getshuttlealignmentstate) | **GET** /aida/v1/box-juv/shuttle/alignment | 
*BoxJuvApi* | [**MoveShuttle**](docs/BoxJuvApi.md#moveshuttle) | **POST** /aida/v1/box-juv/shuttle/move | 
...
*InkjetApi* | [**Action**](docs/InkjetApi.md#action) | **POST** /aida/v1/inkjet/clean-printhead | Passes the wiper on the printhead
...
*InkjetApi* | [**AidaV1InkjetSetPrintheadOffsetPost**](docs/InkjetApi.md#aidav1inkjetsetprintheadoffsetpost) | **POST** /aida/v1/inkjet/set-printhead-offset | 
*InkjetApi* | [**AidaV1InkjetStartPrintPost**](docs/InkjetApi.md#aidav1inkjetstartprintpost) | **POST** /aida/v1/inkjet/start-print | 
*InkjetApi* | [**AidaV1InkjetTransportDebugPost**](docs/InkjetApi.md#aidav1inkjettransportdebugpost) | **POST** /aida/v1/inkjet/transport/debug | 
...
*InkjetApi* | [**EnterMaintenanceMode**](docs/InkjetApi.md#entermaintenancemode) | **POST** /aida/v1/inkjet/enter-maintenance-mode | 
*InkjetApi* | [**ExitMaintenanceMode**](docs/InkjetApi.md#exitmaintenancemode) | **POST** /aida/v1/inkjet/exit-maintenance-mode | 
...
*InkjetApi* | [**GetSupportPrintMethods**](docs/InkjetApi.md#getsupportprintmethods) | **GET** /aida/v1/inkjet/print-methods | 
...
*InkjetApi* | [**PrintJobInstance**](docs/InkjetApi.md#printjobinstance) | **POST** /aida/v1/inkjet/job-template/{jobTemplateId}/instances/{jobInstanceId}/layouts/{inkjetLayoutId}/print | Fetches inkjet perso data for the selected JobInstance from the Data Exchange  Table associated with the selected JobTemplate
...
*InkjetApi* | [**SetCleaningConfiguration**](docs/InkjetApi.md#setcleaningconfiguration) | **POST** /aida/v1/inkjet/cleaning/configuration | Writes configuration parameters in the database and applies parameters to the XEB00011.
...
*InkjetApi* | [**StartInkEmptyingCycle**](docs/InkjetApi.md#startinkemptyingcycle) | **POST** /aida/v1/inkjet/ink-emptying/start | 
*InkjetApi* | [**StopCurrentCycle**](docs/InkjetApi.md#stopcurrentcycle) | **POST** /aida/v1/inkjet/current-cycle/stop | 
...
*InkjetApi* | [**VacuumTest**](docs/InkjetApi.md#vacuumtest) | **POST** /aida/v1/inkjet/vacuum-test | 
...
*InkjetTestApi* | [**SetMultipassAlgorithm**](docs/InkjetTestApi.md#setmultipassalgorithm) | **POST** /aida/v1/inkjettest/set-multipass-algorithm | 
...
*ModbusApi* | [**ReadFloat32Registers**](docs/ModbusApi.md#readfloat32registers) | **POST** /aida/v1/modbus/{port}/read-float32 | 
*ModbusApi* | [**ReadHoldingRegisters**](docs/ModbusApi.md#readholdingregisters) | **POST** /aida/v1/modbus/{port}/read-holding-registers | 
*ModbusApi* | [**ReadInt16**](docs/ModbusApi.md#readint16) | **POST** /aida/v1/modbus/{port}/read-int16 | 
*ModbusApi* | [**ReadInt32**](docs/ModbusApi.md#readint32) | **POST** /aida/v1/modbus/{port}/read-int32 | 
*ModbusApi* | [**WriteFloat32**](docs/ModbusApi.md#writefloat32) | **POST** /aida/v1/modbus/{port}/write-float32 | 
*ModbusApi* | [**WriteInt16**](docs/ModbusApi.md#writeint16) | **POST** /aida/v1/modbus/{port}/write-int16 | 
*ModbusApi* | [**WriteInt32**](docs/ModbusApi.md#writeint32) | **POST** /aida/v1/modbus/{port}/write-int32 | 
*ModbusApi* | [**WriteSingleRegister**](docs/ModbusApi.md#writesingleregister) | **POST** /aida/v1/modbus/{port}/write-register | 
*ModbusApi* | [**WriteString**](docs/ModbusApi.md#writestring) | **POST** /aida/v1/modbus/{port}/write-multiple-registers | 
...
*ToolBoxApi* | [**LaserSightGrid**](docs/ToolBoxApi.md#lasersightgrid) | **GET** /aida/v1/toolbox/laser-sight-grid | Lasers the grid for laser alignment on datapage 1
*ToolBoxApi* | [**PrintAndLaserCalibrationTemplate**](docs/ToolBoxApi.md#printandlasercalibrationtemplate) | **GET** /aida/v1/toolbox/produce-laser-calibration-template | Lasers and prints the template for laser calibration on datapage 1
*ToolBoxApi* | [**PrintAndLaserSightGrid**](docs/ToolBoxApi.md#printandlasersightgrid) | **GET** /aida/v1/toolbox/print-and-laser-sight-grid | Lasers and prints the grid for laser alignment on datapage 1
*ToolBoxApi* | [**PrintSightGrid**](docs/ToolBoxApi.md#printsightgrid) | **GET** /aida/v1/toolbox/print-sight-grid | Prints the grid for laser alignment on datapage 1
...
*WorkflowSchedulerApi* | [**AidaV1WorkflowSchedulerSessionsCurrentJobInstancesGet**](docs/WorkflowSchedulerApi.md#aidav1workflowschedulersessionscurrentjobinstancesget) | **GET** /aida/v1/workflow-scheduler/sessions/current/job-instances | 
...
## Documentation for Models
 ...
 - [Model.InkjetPrinterActionKind](docs/InkjetPrinterActionKind.md)
 - [Model.InkjetPrinterActionResult](docs/InkjetPrinterActionResult.md)
 ...
 - [Model.PrinterActionErrorCodes](docs/PrinterActionErrorCodes.md)
 ...
 - [Model.ReadFieldRequest](docs/ReadFieldRequest.md)
 - [Model.ReadHoldingRegistersRequest](docs/ReadHoldingRegistersRequest.md)
 ...
 - [Model.ShuttleAlignmentState](docs/ShuttleAlignmentState.md)
 ...
 - [Model.WriteFloat32Request](docs/WriteFloat32Request.md)
 - [Model.WriteInt16Request](docs/WriteInt16Request.md)
 - [Model.WriteInt32Request](docs/WriteInt32Request.md)
 - [Model.WriteMultipleRegistersRequest](docs/WriteMultipleRegistersRequest.md)
 - [Model.WriteUInt16Request](docs/WriteUInt16Request.md)
 - [Model.XPrintCappingInfo](docs/XPrintCappingInfo.md)
 - [Model.XPrintCappingStationStatus](docs/XPrintCappingStationStatus.md)
 ...
 - [Model.XPrintMainSystemStatus](docs/XPrintMainSystemStatus.md)
 - [Model.XPrintModuleState](docs/XPrintModuleState.md)
 - [Model.XPrintModuleStateDto](docs/XPrintModuleStateDto.md)
 - [Model.XPrintPhotoSensors](docs/XPrintPhotoSensors.md)
 - [Model.XPrintPowerSupplyStatus](docs/XPrintPowerSupplyStatus.md)
 - [Model.XPrintPrintHeadTemperatureStatus](docs/XPrintPrintHeadTemperatureStatus.md)
 - [Model.XPrintSystemTemperatureStatus](docs/XPrintSystemTemperatureStatus.md)
 - [Model.XPrintTransportAxisPositionFlags](docs/XPrintTransportAxisPositionFlags.md)
 - [Model.XPrintTransportAxisStatus](docs/XPrintTransportAxisStatus.md)
