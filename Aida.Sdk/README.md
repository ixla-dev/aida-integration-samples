...
*WorkflowSchedulerApi* | [**RunExperimentalWorkflow**](docs/WorkflowSchedulerApi.md#runexperimentalworkflow) | **GET** /aida/v1/workflow-scheduler/run-experimental-workflow | 
*WorkflowSchedulerApi* | [**RunTestWorkflow**](docs/WorkflowSchedulerApi.md#runtestworkflow) | **GET** /aida/v1/workflow-scheduler/run-test-workflow | 
...
*WorkflowSchedulerApi* | [**RunWorkflow**](docs/WorkflowSchedulerApi.md#runworkflow) | **GET** /aida/v1/workflow-scheduler/run-workflow | 
...
## Documentation for Models
 ...
 - [Model.ChipEncodingType](docs/ChipEncodingType.md)
